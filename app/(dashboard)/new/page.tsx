...
export default function NewProjectPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Navigate to the project page with the DNA ready
  ...
  return (
    <div className="min-h-full flex items-center justify-center p-8">
      <div className="w-full max-w-2xl">
        {/* Header */}
        <div className="mb-10">
          <p className="font-mono text-xs tracking-[2px] text-ink-3 mb-3">
            NEW PROJECT
          </p>
          ...
          <p className="text-sm text-ink-2 mt-2">
            Write in plain language. SPOS will detect the industry, stage, and
            complexity — and assemble your expert team automatically.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between mt-4">
            <p className="text-xs text-ink-3">
              {idea.length < 20
                ? "Be specific — more detail = better analysis"
          ...
          <div className="mt-8 bg-accent-light border border-accent-border rounded-xl p-5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-ink-3">
                  Detecting industry, assembling expert team...
                </p>
              </div>
            </div>
            <div className="space-y-2">
              {[
                ...
                "Detecting industry and business model",
                "Identifying opportunities and risks",
                "Assembling expert advisory team",
              ].map((step, i) => (
